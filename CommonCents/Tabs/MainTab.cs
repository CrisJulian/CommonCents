    ...
    public partial class Form1 : Form
    {
        ...
        private void SetActiveButton(Button btn)
        {
            ...
            if (_activeButton != null)
            {
                ...
                _activeButton.FlatAppearance.MouseOverBackColor = Color.FromArgb(30, 255, 255, 255); 
            }
            _activeButton = btn;
            _activeButton.BackColor = Color.FromArgb(40, 245, 166, 35); 
            _activeButton.ForeColor = Color.FromArgb(245, 166, 35);   
            _activeButton.FlatAppearance.MouseOverBackColor = Color.FromArgb(40, 245, 166, 35);
        }
